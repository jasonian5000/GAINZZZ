...
export const userSignUp = async (
    ...
    try {
        await fetch('https://localhost:3001/sign_up', {
            method: 'POST',
            headers: {
...
export const userSignIn = async (email, password) => {
    ...
    try {
        const sessionData = await fetch('https://localhost:3001/sign_in', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const trainerInfo = async () => {
    try {
        const trainers = await fetch('https://localhost:3001/trainer_info', {
            method: 'GET',
        })
...
export const getAcctInfo = async () => {
    ...
    try {
        const personalInfo = await fetch('https://localhost:3001/acct_info', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const updateAcctInfo = async updatedInfo => {
    ...
    try {
        await fetch('https://localhost:3001/update_acct_info', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const getUserFavorites = async () => {
    ...
    const body = { userID, access_token }
    try {
        const response = await fetch('https://localhost:3001/get_favorites', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const addToFavorites = async workoutID => {
    ...
    try {
        await fetch('https://localhost:3001/add_favorite', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const removeFavorite = async workoutID => {
    ...
    try {
        await fetch('https://localhost:3001/remove_favorite', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const deleteAcct = async (password) => {
    ...
    try {
        await fetch('https://localhost:3001/delete_acct', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const getWeightData = async () => {
    ...
    try {
        let weightData = await fetch(
            'https://localhost:3001/get_tracked_weight',
            {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
...
export const fetchWorkoutsCompleted = async () => {
    ...
    try {
        const data = await fetch(
            'https://localhost:3001/get_workouts_completed',
            {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
...
export const sendWorkoutsCompleted = async workoutsCompleted => {
    ...
    try {
        await fetch(
            'https://localhost:3001/update_workouts_completed',
            {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
