...
export const userSignUp = async (
    ...
    try {
        await fetch('http://gainzzzz.herokuapp.com/sign_up', {
            method: 'POST',
            headers: {
...
export const userSignIn = async (email, password) => {
    ...
    try {
        const sessionData = await fetch('http://gainzzzz.herokuapp.com/sign_in', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const trainerInfo = async () => {
    try {
        const trainers = await fetch('http://gainzzzz.herokuapp.com/trainer_info', {
            method: 'GET',
        })
...
export const getAcctInfo = async () => {
    ...
    try {
        const personalInfo = await fetch('http://gainzzzz.herokuapp.com/acct_info', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const updateAcctInfo = async updatedInfo => {
    ...
    try {
        await fetch('http://gainzzzz.herokuapp.com/update_acct_info', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const getUserFavorites = async () => {
    ...
    const body = { userID, access_token }
    try {
        const response = await fetch('http://gainzzzz.herokuapp.com/get_favorites', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const addToFavorites = async workoutID => {
    ...
    try {
        await fetch('http://gainzzzz.herokuapp.com/add_favorite', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const removeFavorite = async workoutID => {
    ...
    try {
        await fetch('http://gainzzzz.herokuapp.com/remove_favorite', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const deleteAcct = async (password, navigate) => {
    ...
    const body = { userID, access_token, password }
        await fetch('http://gainzzzz.herokuapp.com/delete_acct', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const getWeightData = async () => {
    ...
    try {
        let weightData = await fetch(
            'http://gainzzzz.herokuapp.com/get_tracked_weight',
            {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
